...
# 1. Optimize and copy the 3 1:1 images to assets/
src_1 = r"C:\Users\moham\.gemini\antigravity\brain\9acc6079-8758-4b60-9ce0-86f829074f1f\.user_uploaded\media_1786737103465.jpg"
src_2 = r"C:\Users\moham\.gemini\antigravity\brain\9acc6079-8758-4b60-9ce0-86f829074f1f\.user_uploaded\media_1786737103460.jpg"
src_3 = r"C:\Users\moham\.gemini\antigravity\brain\9acc6079-8758-4b60-9ce0-86f829074f1f\.user_uploaded\media_1786737103383.jpg"

dest_1 = r"c:\Users\moham\Downloads\blackroots website\assets\blackroots-botanical-pedestal-1x1.jpg"
dest_2 = r"c:\Users\moham\Downloads\blackroots website\assets\blackroots-flatlay-herbs-1x1.jpg"
dest_3 = r"c:\Users\moham\Downloads\blackroots website\assets\blackroots-key-ingredients-1x1.jpg"

for src, dest, name in [(src_1, dest_1, "Hero Pedestal 1:1"), (src_2, dest_2, "Flatlay 1:1"), (src_3, dest_3, "Key Ingredients 1:1")]:
    with Image.open(src) as im:
        rgb_im = im.convert('RGB')
        rgb_im.save(dest, 'JPEG', quality=88, optimize=True)
    print(f"SAVED {name} -> {dest} ({os.path.getsize(dest)/1024:.1f} KB)")

# 2. Update product.html, demo_lab/product.html, preview/product.html with 1:1 square gallery
product_files = [
...
new_gallery_html = """          <!-- Product Gallery Viewport Frame (Ultra-Crisp 1:1 Square Mobile & Desktop Engine) -->
          <div id="ProductMainImageContainer" class="relative w-full aspect-square rounded-3xl overflow-hidden glass-panel-luxury border-2 border-[#d4af37]/40 shadow-2xl flex items-center justify-center bg-[#0a0c10] transition-all duration-300">
            <img id="ProductMainImage" src="./assets/blackroots-botanical-pedestal-1x1.jpg" alt="BlackRoots Botanical Product Showcase" class="w-full h-full object-cover block transition-transform duration-300 group-hover:scale-[1.01]">
          ...
          <!-- Thumbnails Row (Mobile & Desktop Friendly 1:1 Grid) -->
          <div class="grid grid-cols-6 gap-2 sm:gap-3 mt-4">
            <!-- Thumb 1: Botanical Stone Pedestal (Position #1) -->
...
for fpath in product_files:
    if os.path.exists(fpath):
        ...
        content = re.sub(pattern, new_gallery_html.strip(), content, flags=re.DOTALL)

        with open(fpath, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"APPLIED 1:1 SQUARE GALLERY IN: {fpath}")
