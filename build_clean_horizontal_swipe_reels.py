...
clean_swipe_js = """/* 🎬 Smooth Horizontal Swipe Reels Carousel (Clean Instagram/Shorts Style) */
function initReelsModal() {
  ...
  // Auto-play active visible card video on scroll/swipe
...
for jspath in theme_js_files:
    if os.path.exists(jspath):
        ...
        if r_idx != -1:
            ...
            if e_idx != -1:
                content = content[:r_idx] + clean_swipe_js + "\n\n" + content[e_idx:]
                with open(jspath, 'w', encoding='utf-8') as f:
                    f.write(content)
                print(f"UPGRADED CLEAN SWIPE REELS JS IN: {jspath}")
...
clean_swipe_section_html = """  <!-- Watch Reels Section (Smooth Horizontal Swipe Carousel) -->
  <section class="py-10 sm:py-16 bg-[#07080b] border-b border-[#d4af37]/20 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
      ...
      <div class="relative max-w-6xl mx-auto">
        ...
        <!-- Native Smooth Horizontal Swipe Reel Carousel -->
...
for fpath in html_files:
    if os.path.exists(fpath):
        ...
        if s_idx != -1:
            ...
            if e_idx != -1:
                content = content[:s_idx] + clean_swipe_section_html + "\n\n  " + content[e_idx+10:]
                with open(fpath, 'w', encoding='utf-8') as f:
                    f.write(content)
                print(f"APPLIED CLEAN SWIPE REELS CAROUSEL IN: {fpath}")
