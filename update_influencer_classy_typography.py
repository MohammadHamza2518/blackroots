...
# REWRITE INFLUENCER PORTAL WITH SIMPLE CLASSY SANS-SERIF TYPOGRAPHY (influencer.html)
    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <div id="HeaderProfileGroup" class="hidden items-center gap-3">
          <span id="HeaderUserBadge" class="text-xs font-bold text-amber-300 bg-amber-500/10 border border-amber-500/30 px-3.5 py-1.5 rounded-full">
    ...
    <div class="p-6 sm:p-8 rounded-3xl glass-panel-luxury border-2 border-[#d4af37]/50 shadow-2xl bg-gradient-to-b from-[#12151c] to-[#0a0b0e] space-y-6 relative overflow-hidden">
      ...
      <form onsubmit="handleLoginSubmit(event)" class="space-y-4 text-xs relative z-10">
        ...
        <div class="space-y-1.5">
          ...
          <input id="LoginUserID" type="text" required placeholder="priya" class="w-full bg-[#0a0b0e] border border-white/10 rounded-xl p-3.5 text-white font-mono text-sm focus:outline-none focus:border-[#d4af37] transition-all">
        </div>

        <div class="space-y-1.5">
          <label class="font-bold text-gray-300 uppercase tracking-wider block text-[11px]">Password</label>
          <div class="relative flex items-center">
            <input id="LoginPassword" type="password" required placeholder="priya123" class="w-full bg-[#0a0b0e] border border-white/10 rounded-xl p-3.5 pr-10 text-white font-mono text-sm focus:outline-none focus:border-[#d4af37] transition-all">
  ...
  <main id="DashboardSection" class="hidden max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full space-y-8">
    ...
    <div class="p-6 sm:p-8 rounded-3xl glass-panel-luxury border-2 border-[#d4af37]/40 shadow-2xl relative overflow-hidden bg-gradient-to-br from-[#12151c] via-[#0d0e12] to-black">
      ...
      <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div class="flex items-center gap-4">
          ...
          <div>
            <div class="flex items-center gap-2">
              <h1 id="DashCreatorName" class="text-xl sm:text-3xl font-extrabold text-white tracking-tight">Priya Sharma</h1>
              <span class="text-[10px] font-extrabold uppercase bg-amber-500/20 text-amber-300 border border-amber-500/40 px-2.5 py-0.5 rounded-full tracking-wider">GOLD CREATOR</span>
            </div>
            <p class="text-xs sm:text-sm text-gray-400 mt-1 font-medium">User ID: <strong id="DashUserID" class="text-amber-300 font-mono">priya</strong> &bull; <span id="DashCreatorHandle">@priya_beauty_lifestyle</span> &bull; <span class="text-emerald-400 font-semibold">15% Commission Rate</span></p>
          </div>
        </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="p-5 rounded-2xl glass-panel-luxury border border-[#d4af37]/30 bg-[#12151c]/80 shadow-xl space-y-1.5">
        ...
        <div class="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">₹48,900.00</div>
      ...
      <div class="p-5 rounded-2xl glass-panel-luxury border border-[#d4af37]/30 bg-[#12151c]/80 shadow-xl space-y-1.5">
        ...
        <div class="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">38 Orders</div>
        <p class="text-[11px] text-gray-400 font-medium">Avg Order: ₹1,286</p>
      </div>
      ...
      <div class="p-5 rounded-2xl glass-panel-luxury border border-[#d4af37]/30 bg-[#12151c]/80 shadow-xl space-y-1.5">
        ...
        <div class="text-2xl sm:text-3xl font-extrabold text-amber-300 tracking-tight">₹7,335.00</div>
        <p class="text-[11px] text-gray-400 font-medium">₹2,445 Settled</p>
      </div>
      ...
      <div class="p-5 rounded-2xl glass-panel-luxury border-2 border-emerald-500/40 bg-[#123824]/30 shadow-xl space-y-1.5 relative overflow-hidden">
        ...
        <div class="text-2xl sm:text-3xl font-extrabold text-emerald-400 tracking-tight">₹4,890.00</div>
    ...
    <div class="p-6 rounded-3xl glass-panel-luxury border border-[#d4af37]/30 bg-[#12151c] shadow-2xl space-y-6">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
        <div>
          ...
          <p class="text-xs text-gray-400 font-medium">Assigned by Store Owner. Followers get 10% OFF & you earn 15% Commission on every sale!</p>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-2 bg-[#0a0b0e] border-2 border-[#d4af37]/60 rounded-2xl p-2 shadow-inner">
            ...
            <button type="button" onclick="copyToClipboard('PRIYA10', 'Promo Code PRIYA10 Copied!')" class="ml-auto bg-[#d4af37] hover:bg-amber-400 text-black font-extrabold text-xs px-4 py-2.5 rounded-xl transition-all shadow-md cursor-pointer">
              Copy Code
            </button>
          </div>
        </div>
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-2 bg-[#0a0b0e] border border-white/10 rounded-2xl p-2 shadow-inner">
            ...
            <button type="button" onclick="copyToClipboard('https://blackroots.in/?ref=PRIYA10', 'Referral Link Copied!')" class="ml-auto bg-white/10 hover:bg-white/20 text-white font-bold text-xs px-4 py-2.5 rounded-xl transition-all cursor-pointer">
              Copy Link
            </button>
          </div>
        </div>
    ...
    <div class="p-6 rounded-3xl glass-panel-luxury border border-[#d4af37]/30 bg-[#12151c] shadow-2xl space-y-5">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 class="text-lg font-bold text-white tracking-tight">Sales Brought By Your Code (<span id="DashTableCode">PRIYA10</span>)</h2>
        ...
        <table class="w-full text-left text-xs border-collapse">
          ...
          <tbody class="divide-y divide-white/5 font-medium text-gray-300">
            <tr class="hover:bg-white/5 transition-colors">
              ...
              <td class="py-3.5 px-4 text-gray-400">Today, 06:42 PM</td>
            ...
            <tr class="hover:bg-white/5 transition-colors">
              ...
              <td class="py-3.5 px-4 text-gray-400">Yesterday, 02:15 PM</td>
            ...
            <tr class="hover:bg-white/5 transition-colors">
              ...
              <td class="py-3.5 px-4 text-gray-400">11 Aug 2026</td>
  ...
  <div id="PayoutModal" class="fixed inset-0 z-50 bg-black/80 backdrop-blur-md hidden items-center justify-center p-4">
    <div class="bg-[#12151c] border-2 border-[#d4af37]/50 rounded-3xl max-w-md w-full p-6 shadow-2xl relative space-y-5">
      ...
      <div class="space-y-1">
        ...
        <p class="text-xs text-gray-400 font-medium">Available Unpaid Balance: <strong class="text-emerald-400 font-extrabold">₹4,890.00</strong></p>
      </div>
...
for d in target_dirs:
    if os.path.exists(d):
        ...
        print(f"UPDATED CLASSY SANS-SERIF TYPOGRAPHY IN: {d}")
