...
code_payment_badges_html = """          <div id="MainBuyButton" class="pt-3 pb-2 space-y-3">
    ...
    if os.path.exists(fpath):
        ...
        if idx_start != -1:
            ...
            if idx_end != -1:
                ...
                if last_div != -1:
                    content = content[:idx_start] + code_payment_badges_html + content[last_div + 6:]
                    with open(fpath, 'w', encoding='utf-8') as f:
                        f.write(content)
                    print(f"REPLACED WITH CODE-RENDERED LUXURY PAYMENT BADGES IN: {fpath}")
