...
new_gallery_container = """          <div class="relative w-full aspect-square sm:aspect-[4/3] rounded-3xl overflow-hidden glass-panel-luxury border-2 border-[#d4af37]/40 shadow-2xl flex items-center justify-center group bg-[#0d0e12]">
          ...
          <div class="grid grid-cols-4 sm:grid-cols-8 gap-2 mt-4">
            ...
            <!-- Thumb 2: Herbal Splash (Position #2) -->
            ...
            <!-- Thumb 3: Flatlay Herbs Table (Position #3) -->
            ...
            <!-- Thumb 4: Key Ingredients Infographic (Position #4) -->
            ...
            <!-- Thumb 5: How To Use 5 Steps (Position #5) -->
            ...
            <!-- Thumb 6: Liquid Dispenser Texture (Position #6) -->
            ...
            <!-- Thumb 7: Shower Hair Washing (Position #7) -->
            ...
            <!-- Thumb 8: 8-Sec Video Reel Link (Position #8) -->
...
for fpath in files:
    if os.path.exists(fpath):
        ...
        if start_idx != -1 and end_idx != -1:
            ...
            # Fallback replace
            start_idx = content.find('<div class="relative aspect-square')
            if start_idx == -1:
                start_idx = content.find('<div class="relative w-full aspect-square')
        ...
        with open(fpath, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"REMOVED PLAIN BOTTLE & LOCKED USER SEQUENCE IN: {fpath}")
