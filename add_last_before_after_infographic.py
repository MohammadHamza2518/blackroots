...
src_img = r"C:\Users\moham\.gemini\antigravity\brain\b4fb9873-4d37-42bd-ae35-964df1e66b68\.user_uploaded\media_1786630503860.jpg"

dest_main = r"c:\Users\moham\Downloads\blackroots website\assets\blackroots-before-after-infographic.jpg"
dest_demo = r"c:\Users\moham\Downloads\blackroots website\demo_lab\assets\blackroots-before-after-infographic.jpg"
dest_prev = r"c:\Users\moham\Downloads\blackroots website\preview\assets\blackroots-before-after-infographic.jpg"

shutil.copy2(src_img, dest_main)
if os.path.exists(os.path.dirname(dest_demo)):
    shutil.copy2(src_img, dest_demo)
if os.path.exists(os.path.dirname(dest_prev)):
    shutil.copy2(src_img, dest_prev)

print("COPIED NEW BEFORE-AFTER COMPARISON INFOGRAPHIC TO ASSETS!")
...
new_gallery_container = """          <!-- Product Gallery Viewport Frame (Adaptive Aspect Ratio & Zero Cropping) -->
...
for fpath in files:
    if os.path.exists(fpath):
        ...
        with open(fpath, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"ADDED COMPARISON INFOGRAPHIC TO GALLERY END IN: {fpath}")
